...
- (instancetype)initWithDictionary:(NSDictionary *)dict {
    ...
    if (self && [dict isKindOfClass:[NSDictionary class]]) {
            ...
            self.carPrice = [[self objectOrNilForKey:kRentalBookingResponseCarPrice fromDictionary:dict] integerValue];
            ...
            self.extrasPrice = [[self objectOrNilForKey:kRentalBookingResponseExtrasPrice fromDictionary:dict] integerValue];
            self.insurancePrice = [[self objectOrNilForKey:kRentalBookingResponseInsurancePrice fromDictionary:dict] integerValue];
            self.total = [[self objectOrNilForKey:kRentalBookingResponseTotal fromDictionary:dict] integerValue];
...
- (NSDictionary *)dictionaryRepresentation {
    ...
    [mutableDict setValue:[NSNumber numberWithInteger:self.carPrice] forKey:kRentalBookingResponseCarPrice];
    ...
    [mutableDict setValue:[NSNumber numberWithInteger:self.extrasPrice] forKey:kRentalBookingResponseExtrasPrice];
    [mutableDict setValue:[NSNumber numberWithInteger:self.insurancePrice] forKey:kRentalBookingResponseInsurancePrice];
    [mutableDict setValue:[NSNumber numberWithInteger:self.total] forKey:kRentalBookingResponseTotal];
